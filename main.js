...
let ism = harflar[0] + harflar[11] + harflar[7];
console.log(ism); // 
...
let natijaDiv = document.createElement("div");
natijaDiv.style.color = "blue";
natijaDiv.style.fontSize = "24px";
natijaDiv.style.fontWeight = "bold";
natijaDiv.style.marginTop = "20px";
natijaDiv.style.fontFamily = "Arial, sans-serif";


natijaDiv.innerHTML = Ismingiz [ism] <br> Yoshingiz [yosh];
